...
public class AsteroidSilicon extends Asteroid {
	public AsteroidSilicon (String designation) throws ClassNotFoundException, SQLException {
		super();
	...
	public String toString() {
		return "------------- AsteroidSilicon: " + getDesignation() + " ------------- \n "
